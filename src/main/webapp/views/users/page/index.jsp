...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover" style="background-image: url(${pageContext.request.contextPath}/images/hero_1.jpg);" data-aos="fade">
      <div class="container">
        <div class="row align-items-start align-items-md-center justify-content-end">
          <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
            ...
            <div class="intro-text text-center text-md-left">
              ...
              <p>
                <a href="${ pageContext.request.contextPath }/users/home" class="btn btn-sm btn-primary">Shop Now</a>
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="nonloop-block-3 owl-carousel">
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="${pageContext.request.contextPath}/images/cloth_1.jpg" alt="Image placeholder" height="auto" width="100%">
                  </figure>
              ...
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="${pageContext.request.contextPath}/images/shoe_1.jpg" alt="Image placeholder" height="auto" width="100%">
                  </figure>
                  <div class="block-4-text p-4">
              ...
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="${pageContext.request.contextPath}/images/cloth_2.jpg" alt="Image placeholder" height="auto" width="100%">
                  </figure>
                  <div class="block-4-text p-4">
              ...
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="${pageContext.request.contextPath}/images/cloth_3.jpg" alt="Image placeholder" height="auto" width="100%">
                  </figure>
                  <div class="block-4-text p-4">
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 mb-5">
            <a href="#"><img src="${pageContext.request.contextPath}/images/blog_1.jpg" alt="Image placeholder" height="auto" width="100%"></a>
          </div>
          <div class="col-md-12 col-lg-5 text-center pl-md-5">
            <h2><a href="#">50% less in all items</a></h2>
            <p class="post-meta mb-4">By <a href="#">Carl Smith</a> <span class="block-8-sep">&bullet;</span> September 3, 2018</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam iste dolor accusantium facere corporis ipsum animi deleniti fugiat. Ex, veniam?</p>
            <p><a href="${ pageContext.request.contextPath }/users/home" class="btn btn-primary btn-sm">Shop Now</a></p>
          </div>
        </div>
      </div>
    </div>
