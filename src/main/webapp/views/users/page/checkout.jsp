...
<html lang="en">
  ...
  <%-- <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="${ pageContext.request.contextPath }/users/home/index">Home</a> <span class="mx-2 mb-0">/</span> <a href="cart.html">Cart</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Checkout</strong></div>
        </div>
      </div>
    </div>
            ...
            <div class="p-3 p-lg-5 border">
              <div class="form-group">
                ...
                <select id="c_country" class="form-control">
                  ...
                  <option value="7">Can Tho</option>    
                  <option value="8">Ha Nam</option>    
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  ...
                  <form:input type="text" path="address" class="form-control" id="c_address" name="address" placeholder="Street address" />
              ...
              <div class="form-group row mb-5">
                ...
                <div class="col-md-6">
                  ...
                  <form:input type="text" path="phone" class="form-control" id="c_phone" name="phone" placeholder="Phone Number" />
                  ...
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody>              
                      <tr>
                        ...
                        <td class="text-black font-weight-bold">${cart.getCount()}</td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
                        <td class="text-black font-weight-bold"><strong>${cart.getAmount()} $</strong></td>
                      </tr>
                    </tbody>
                  </table>
          ...
          <div class="col-md-6 mb-5 mb-md-0">
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  <label for="c_fname" class="text-black">First Name <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" id="c_fname" name="c_fname" value="${user.username }" >
                </div>
                <div class="col-md-6">
                  <label for="c_lname" class="text-black">Last Name <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" id="c_lname" name="c_lname" value="Nguyen">
                </div>
              </div>
              ...
              <div class="form-group">
				...
				<div class="form-group">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="submitOrder()">Place Order</button>
                  </div>
            </div>
            </form:form>
          </div>
  ...
  function submitOrder(){
		...
		$.ajax({
		    url: "/users/home/cart/submitOrder",
		    type: "get",
