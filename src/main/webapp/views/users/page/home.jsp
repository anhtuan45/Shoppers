...
<html lang="en">
  ...
  <div class="site-wrap">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-6 col-md-4 order-2 order-md-1 site-search-icon text-left">
              <form action="${ pageContext.request.contextPath }/users/home" class="site-block-top-search">
                <span class="icon icon-search2"></span>
                <input type="text" name="keyword" id="keyword" value="${keyword}" class="form-control border-0" placeholder="Search">
              </form>
            </div>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="${ pageContext.request.contextPath }/users/home/index">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Shop</strong></div>
        </div>
      </div>
    </div>
		              ...
		              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
		                ...
		                <div class="block-4 text-center border">
		                  <figure class="block-4-image">
		                    <a href="${ pageContext.request.contextPath }/users/home/${product.id}"><img src="${pageContext.request.contextPath}/images/${product.image}" alt="Image placeholder" class="img-fluid"></a>
		                  </figure>
		                  <div class="block-4-text p-4">
		                    <%-- <h3><a href="${ pageContext.request.contextPath }/users/home/shop-single">${product.name}</a></h3> --%>
		                    <h3><a href="${ pageContext.request.contextPath }/users/home/${product.id}">${product.name}</a></h3>
		                    <p class="text-primary font-weight-bold">${product.price } $</p>
		                    <p><a href="${ pageContext.request.contextPath }/users/home/cart/add/${product.id}" class="buy-now btn btn-sm btn-primary">Add To Cart</a></p>
		                  </div>
		                </div>
              ...
              <div class="col-md-12 text-center">
                <div class="site-block-27">
                  <ul>
                    ...
                    <li><a href="#">&lt;</a></li>
                    <c:forEach begin="0" end="${ products.totalPages > 0 ? products.totalPages - 1 : 0}" varStatus="page">
                    	<%-- <li><a href="${ pageContext.request.contextPath }/users/home?page=0&limit=12">&lt;</a></li> --%>
						<li class="active">
							<span>
								<a class="page-link" href="${ pageContext.request.contextPath }/users/home?page=${page.index}&limit=12">${ page.index + 1 }</a>
							</span>
						</li>
          ...
          <div class="col-md-3 order-1 mb-5 mb-md-0">
            <div class="border p-4 rounded mb-4">
              ...
              <ul class="list-unstyled mb-0">
                ...
                <li class="mb-1"><a class="dropdown-item" href="${ pageContext.request.contextPath }/users/home">All</a></li>
                <c:forEach items="${ categoryData }" var="category">
					<li class="mb-1"><a href="#" class="d-flex"><a class="dropdown-item" href="${ pageContext.request.contextPath }/users/home?categories=${category.id}" >${category.name}</a></li>
				</c:forEach>
              </ul>
            </div>
                ...
                <div class="row">
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
                    <a class="block-2-item" href="#">
                      <figure class="image">
                        <img src="${ pageContext.request.contextPath }/images/women.jpg" alt="" height="auto" width="100%">
                      </figure>
                      <div class="text">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
                    <a class="block-2-item" href="#">
                      <figure class="image">
                        <img src="${ pageContext.request.contextPath }/images/children.jpg" alt="" height="auto" width="100%">
                      </figure>
                      <div class="text">
                        <span class="text-uppercase">Collections</span>
                        <h3>Children</h3>
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
                    <a class="block-2-item" href="#">
                      <figure class="image">
                        <img src="${ pageContext.request.contextPath }/images/men.jpg" alt="" height="auto" width="100%">
                      </figure>
                      <div class="text">
                        <span class="text-uppercase">Collections</span>
                        <h3>Men</h3>
